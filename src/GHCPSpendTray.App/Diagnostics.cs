...
internal static class Diagnostics
{
    ...
    internal static void Record(string category)
    {
        lock (Gate)
        {
            ...
            {
                Native.Win32.MessageBox(0, "GHCPSpendTray cannot write its diagnostic log. Check data-folder permissions and free space.",
                    "GHCPSpendTray storage error", Native.Win32.MB_ICONERROR);
            }
        }
    }
}
